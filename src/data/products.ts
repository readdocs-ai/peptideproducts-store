...
export const categories: { key: Category; blurb: string }[] = [
  {
    key: "Antioxidants",
    blurb: "Antioxidant-focused peptide and compound lines for laboratory research.",
  },
  {
    key: "Hydration",
    blurb: "Hydration-focused carrier systems and related compounds for formulation research.",
  },
  {
    key: "Firming",
    blurb: "Elasticity and firmness-focused peptide research blends for laboratory study.",
  },
  {
    key: "Regenerative",
    blurb: "Repair and regeneration-focused research compounds for scientific investigation.",
  },
  {
    key: "Metabolic",
    blurb: "Metabolic and receptor-pathway peptide compounds for laboratory research.",
  },
];
...
export const products: Product[] = [
  {
    ...
    highlights: [
      "Antioxidant-focused laboratory research compound",
      "Commonly reviewed alongside Vitamin C workflows",
      "Research-use-only product supply",
    ],
...

  {
    ...
    highlights: [
      "Hydration-focused carrier blend for laboratory study",
      "Common in formulation and compatibility research",
      "Research-use-only product supply",
    ],
...

  {
    ...
    highlights: [
      "Firming peptide blend for laboratory research",
      "Elasticity-focused research workflows",
      "Research-use-only product supply",
    ],
...

  {
    ...
    highlights: [
      "Collagen-focused laboratory research blend",
      "Often reviewed in regeneration-related studies",
      "Research-use-only product supply",
    ],
...

  {
    ...
    highlights: [
      "PDRN-based regeneration research compound",
      "Repair and compatibility-focused workflows",
      "Research-use-only product supply",
    ],
...

  {
    ...
    highlights: [
      "Vitamin C-focused antioxidant research compound",
      "Often reviewed in brightening and formulation workflows",
      "Research-use-only product supply",
    ],
...

  {
    ...
    highlights: [
      "Retatrutide 40mg pre-filled research peptide pen",
      "Metabolic and receptor-pathway research positioning",
      "Research-use-only product supply in the UK",
    ],
