    ...
    images: [
      {
        ...
        width: 1400,
        height: 1080,
        alt: "Peptide Products premium research peptide range",
      },
    ],
  },
};
...
const documentationCards = [
  {
    title: "GHK-CU 100mg COA",
    image: "/docs/previews/ghk-cu-100mg.jpg",
    href: "/product/ghk-cu-100mg",
    copy: "Available directly from the product page with preview image and download link.",
  },
  {
    title: "BPC-157 5mg COA",
    image: "/docs/previews/bpc-157-5mg.jpg",
    href: "/product/bpc-157-5mg",
    copy: "Review selected paperwork before ordering on qualifying product lines.",
  },
  {
    title: "Tesamorelin report preview",
    image: "/docs/previews/tesamorelin-report.jpg",
    href: "/quality-assurance",
    copy: "Additional previews and product-linked files are available in the quality hub.",
  },
] as const;
...
const trustCards = [
  {
    ...
    copy: "Selected products include certificate files or previews where documentation is available.",
  },
  {
...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "Yes. Selected product pages include certificate files directly on the page, and the quality section links broader available documentation.",
  },
  {
            ...
            <div className="grid gap-8 lg:grid-cols-[1.02fr_0.98fr] lg:items-center">
              <div>
                ...
                <h1 className="mt-5 max-w-3xl text-4xl font-extrabold tracking-tight md:text-5xl lg:text-6xl lg:leading-[1.05]">
                  Research peptides and laboratory compounds for analytical and scientific study.
                </h1>

                <p className="mt-5 max-w-2xl text-base leading-7 text-muted md:text-lg">
                  Browse the catalogue, review available documentation on selected products, and order through secure checkout with tracked UK dispatch.
                </p>
                ...
                <div className="mt-6 flex flex-wrap gap-2">
                  ...
                  <span className="trust-pill">Available COA documents</span>
              ...
              <div className="glass-card overflow-hidden">
                <div className="relative h-[320px] md:h-[460px]">
                  <Image
                    src="/hero/premium-lab-hero.svg"
                    alt="Premium laboratory illustration for Peptide Products"
                    fill
                    priority
                    sizes="(min-width: 1024px) 46vw, 100vw"
                    className="object-contain p-4 md:p-6"
                  />
                  <div className="absolute left-5 top-5 premium-badge">UK research supply</div>
                </div>

                <div className="grid gap-4 border-t border-line/70 bg-white/90 p-6 sm:grid-cols-3">
                  <div>
                    <div className="soft-label">Documentation</div>
                    <p className="mt-2 text-sm leading-6 text-muted">Selected product pages include certificate previews and downloadable paperwork where available.</p>
                  </div>
                  <div>
                    <div className="soft-label">Support</div>
                    <p className="mt-2 text-sm leading-6 text-muted">Direct email and UK phone support remain visible before checkout.</p>
                  </div>
                  <div>
                    <div className="soft-label">Checkout</div>
                    <p className="mt-2 text-sm leading-6 text-muted">Card checkout and alternative payment options are available through the cart.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
              {trustCards.map((card) => (
                <div key={card.title} className="feature-card">
                  <div className="text-lg font-extrabold tracking-tight text-ink">{card.title}</div>
        ...
        <section className="py-10 lg:py-14">
          <Container>
            <div className="flex flex-wrap items-end justify-between gap-6">
              <div>
                <div className="eyebrow">Documentation spotlight</div>
                <h2 className="mt-4 section-title">Quality documents available on selected products.</h2>
                <p className="mt-3 max-w-2xl section-copy">
                  Review available certificates, report previews, and supporting paperwork from the quality hub and linked product pages.
                </p>
              </div>
              <Link href="/quality-assurance" className="text-sm font-extrabold text-ink/80 hover:text-ink">
            ...
            <div className="mt-6 grid gap-6 lg:grid-cols-3">
              {documentationCards.map((item) => (
                <Link key={item.title} href={item.href} className="surface-card overflow-hidden">
                  <div className="relative h-[220px] bg-panel">
                    <Image src={item.image} alt={item.title} fill sizes="(min-width:1024px) 33vw, 100vw" className="object-cover" />
                  </div>
                  <div className="p-5">
                    <div className="soft-label">Documentation</div>
                    <div className="mt-2 text-xl font-extrabold tracking-tight text-ink">{item.title}</div>
                    <p className="mt-3 text-sm leading-7 text-muted">{item.copy}</p>
                    <div className="mt-4 text-sm font-extrabold text-ink">Open →</div>
                  </div>
                </Link>
              ))}
            </div>
          ...
          <Container>
            <div className="flex flex-wrap items-end justify-between gap-6">
              <div>
                ...
                <p className="mt-2 max-w-2xl text-sm text-muted">Start with the most viewed products in the current range.</p>
              </div>
          ...
          <Container>
            ...
            <div className="mt-6 grid gap-6 lg:grid-cols-3">
              {categoryCards.map((card) => (
                <Link key={card.title} href={card.href} className="group overflow-hidden rounded-xl3 border border-line bg-white shadow-soft transition duration-200 hover:-translate-y-0.5 hover:shadow-lift">
                  ...
                  <div className="p-5">
                    <h3 className="text-lg font-extrabold tracking-tight text-ink">{card.title}</h3>
          ...
          <Container>
            <div className="flex flex-wrap items-end justify-between gap-6">
              <div>
                ...
                <h2 className="mt-4 section-title">Explore the main research guides and category pages.</h2>
                <p className="mt-2 max-w-2xl text-sm text-muted">
                  Use these pages to explore broader topics, compare categories, and move into relevant product lines more quickly.
                </p>
              </div>
            </div>
          ...
          <Container>
            <div className="grid gap-8 lg:grid-cols-[1fr_0.9fr] lg:items-start">
              ...
              <div className="glass-card p-6">
                <h2 className="text-2xl font-extrabold tracking-tight text-ink">Start with a research guide</h2>
                <p className="mt-3 text-sm leading-7 text-muted">
                  Go straight to the catalogue, review documentation, or contact support before ordering.
                </p>
                ...
                <div className="mt-6 grid gap-3">
                  ...
                  <Link href="/quality-assurance" className="rounded-xl2 border border-line bg-white px-5 py-3 text-sm font-extrabold text-ink shadow-soft hover:bg-panel">
                    Quality & documentation
                  </Link>
