...
export const metadata: Metadata = {
  title: "BPC-157 UK | Laboratory Research Compound Supply",
  description:
    "BPC-157 UK laboratory research compound page with product access, pricing links, secure checkout guidance, UK delivery information, and research-use-only supply.",
  alternates: {
    canonical: "https://www.peptideproducts.co.uk/bpc-157-uk",
  },
};

const faqs = [
  {
    q: "Is BPC-157 listed for human use?",
    a: "No. BPC-157 products listed by Peptide Products are supplied strictly for laboratory, analytical, and scientific research use only.",
  },
  {
    q: "Can UK customers order BPC-157 online?",
    a: "Yes. Customers can view the BPC-157 product page, review product information, and complete checkout through the website.",
  },
  {
        ...
        <Container>
          <div className="mx-auto max-w-4xl">
            ...
            <h1 className="mt-4 text-4xl font-extrabold tracking-tight md:text-5xl">
              BPC-157 UK laboratory research compound
            </h1>

            <p className="mt-5 text-base leading-8 text-muted">
              UK-based supply of BPC-157 research compound with transparent
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              >
                Regenerative research products
              </Link>
            ...
            <section className="mt-12 rounded-xl3 border border-line bg-white p-6 shadow-soft">
              <h2 className="text-2xl font-extrabold tracking-tight">
                BPC-157 availability in the UK
              </h2>

              <p className="mt-4 text-sm leading-7 text-muted">
                Peptide Products provides BPC-157 product information for UK
            ...
            <section className="mt-8 rounded-xl3 border border-line bg-white p-6 shadow-soft">
              ...
              <div className="mt-5 grid gap-3 sm:grid-cols-2">
                ...
                <Link href="/ghk-cu-uk" className="surface-card p-5">
                  <div className="font-extrabold text-ink">GHK-CU UK</div>
                  <p className="mt-2 text-sm text-muted">
                    View related research compound information.
                  </p>
                </Link>
