    ...
    <main className="mx-auto max-w-7xl px-6 py-10">
      <div className="mb-8 flex flex-wrap items-end justify-between gap-4">
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <Link
            href="/admin/reports"
            className="rounded-xl2 border border-emerald-200 bg-emerald-50 px-5 py-3 text-sm font-extrabold text-emerald-800 shadow-soft hover:bg-emerald-100"
          >
            Bank & accountant centre
          </Link>
                  ...
                  <div>
                    ...
                    <div className="mt-5 grid gap-4 md:grid-cols-2">
                      <div className="rounded-xl2 border border-line bg-panel p-4">
                        ...
                        <div className={"mt-3 mr-2 inline-flex rounded-full px-3 py-1 text-xs font-extrabold " + (order.researchUseAccepted ? "border border-blue-200 bg-blue-50 text-blue-700" : "border border-line bg-white text-muted")}>
                          {order.researchUseAccepted ? `Research declaration accepted${order.researchUseAcceptedAt ? ` · ${formatDate(order.researchUseAcceptedAt)}` : ""}` : "No recorded research declaration"}
                        </div>
                        <div
                          className={
                  ...
                  <div className="rounded-xl2 border border-line bg-panel p-4">
                    <div className="flex items-center justify-between gap-3">
                      ...
                      <Link
                        ...
                        target="_blank"
                        className="rounded-lg border border-line bg-white px-3 py-2 text-xs font-extrabold text-ink hover:bg-panel"
                      >
                        Print packing slip
                      </Link>
                    </div>
