  ...
  return (
    <>
      <div className="border-b border-line bg-ink text-white">
        <Container>
          <div className="flex flex-col gap-2 py-2 text-[11px] font-semibold sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex flex-wrap items-center gap-x-4 gap-y-1">
              <a href={`mailto:${brand.supportEmail}`} className="text-white hover:text-white/80">
                {brand.supportEmail}
              </a>
              <span className="text-white/65">{brand.phone}</span>
            </div>
          </div>
        </Container>
      </div>
